...
async def test_llm_filter():
    ...
    async with AsyncWebCrawler(config=browser_config) as crawler:
        ...
        filter = LLMContentFilter(
            ...
            instruction="""Focus on extracting the core educational content about Python classes.
            Include:
        ...
        filter = LLMContentFilter(
            ...
            ignore_cache = True,
            instruction="""Extract the main educational content while preserving its original wording and substance completely. Your task is to:
