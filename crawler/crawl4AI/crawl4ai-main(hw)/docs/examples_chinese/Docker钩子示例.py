...
async def main():
    ...
    print("   • Pros: All benefits of # + cleaner code, no manual conversion")

    print("\n💡 Recommendation:")
    print("   Use Docker Client (# ) for Python applications")
    print("   Use hooks_to_string() (# ) when you need REST API flexibility")
    print("   Use string-based (# ) for non-Python clients or simple scripts")
