...
class GitHubSearchScraper:
    ...
    async def generate_search_script(self) -> str:
        ...
        search_goal = """Search for crawl4AI repositories written in Python with more than 10000 stars:
    ...
    async def generate_result_schema(self) -> Dict[str, Any]:
        ...
        schema_goal = """Create a JSON CSS extraction schema to extract from each repository card:
